...
import { IDocument } from '../types'; // Assuming IDocument is in types, for documents:list_update
...
import AudienceQA from '../components/AudienceQA'; // Import AudienceQA
      ...
      <div className="min-h-screen bg-bg-secondary text-text-primary">
        <header className="bg-bg-primary shadow">
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <h1 className="text-xl font-bold text-text-primary">{t('interactiveWordCloud')}</h1>
            {currentParticipant && (
  ...
  if (isAudienceQAActive) {
    return (
      <div className="min-h-screen bg-bg-secondary text-text-primary">
        <header className="bg-bg-primary shadow">
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <h1 className="text-xl font-bold text-text-primary">{t('audienceQA')}</h1>
            {currentParticipant && (
              <div className="flex items-center space-x-4">
                <span className="text-sm font-medium text-text-secondary">
                  {t('participant')}: {currentParticipant.name}
