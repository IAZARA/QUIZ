...
import { PlusCircle, Play, StopCircle, LogOut, Trash2, Eye, EyeOff, Clock, Edit2, Check, RefreshCw, Upload } from 'lucide-react';
          ...
          <div className="px-4 py-5 sm:p-6 flex space-x-4">
            ...
            <button
              onClick={async () => {
                try {
                  await clearView();
                  alert('Vista de audiencia limpiada correctamente');
                } catch (error) {
                  console.error('Error al limpiar la vista:', error);
                  alert('Error al limpiar la vista');
                }
              }}
                      ...
                      <div className="relative bg-gray-100 rounded overflow-hidden">
                        ...
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            target.className = 'max-h-40 max-w-full object-contain rounded mx-auto border border-red-300';
                          }}
                        />
                      </div>
                    </div>
